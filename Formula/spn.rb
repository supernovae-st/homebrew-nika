...
class Spn < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/supernovae-st/supernovae-cli/releases/download/v0.4.0/spn-aarch64-apple-darwin.tar.gz"
      sha256 "1051d6398adfa9b018da460ea87f85a99a8158d6ef39b28c1a69ccd835f9d409"
    end
    on_intel do
